...
| <a name="input_consumer_policy_actions"></a> [consumer_policy_actions](#input_consumer_policy_actions)                   | Map of multiple S3 consumer policies to be applied to bucket e.g. {EC2Read = [s3:GetObject, s3:ListObject], FirehoseWrite =[s3:PutObjectAcl]}                                                                                                                              | `map(list(string))`                                                                                                                                                       | `{}`                                            |    no    |
| <a name="input_enable_object_lock"></a> [enable_object_lock](#input_enable_object_lock)                                  | Enable Object Lock configuration. Default is disabled.                                                                                                                                                                                                                     | `bool`                                                                                                                                                                    | `false`                                         |    no    |
...
| <a name="input_kms_key_additional_policies"></a> [kms_key_additional_policies](#input_kms_key_additional_policies)       | Additional IAM policies block, input as data source. Ref: https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document                                                                                                               | `list(string)`                                                                                                                                                            | `[]`                                            |    no    |
