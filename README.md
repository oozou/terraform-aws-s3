...
| <a name="input_cors_rule"></a> [cors_rule](#input_cors_rule)                                                                            | List of core rules to apply to S3 bucket.                                                                                                                                                                                                                                  | <pre>list(object({<br> id = string<br> allowed_headers = list(string)<br> allowed_methods = list(string)<br> allowed_origins = list(string)<br> expose_headers = list(string)<br> max_age_seconds = number<br> }))</pre> | `[]`    |    no    |
